      ...
      if (inbus == 0 || !has_contents[inbus]) {
        ...
        if ((flags & 0xc0) == 0xc0 && fb_on) {
          switch ( algorithm ) {
            ...
            case 3 :
              compute_fb3(outptr, params, gain1, gain2, fb_buf, std::min<int32_t>((feedback_shift + 2), 16));
            ...
            case 5 :
              compute_fb2(outptr, params, gain1, gain2, fb_buf, std::min<int32_t>((feedback_shift + 2), 16));
